<div class="hero_area">
    ...
    <section class="slider_section mt-2 pt-5">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="detail-box">
                                        <h1>
                                            Chào mừng bạn đến với <br> APT Shop
                                        </h1>
                                        <p>
                                            Cuộc sống là hành trình không ngừng bứt phá để chinh phục những tầm cao mới.
                                        </p>
                                ...
                                <div class="col-md-5 ">
                                    <div class="img-box">
                                        <img src="images/items-banner.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="detail-box text-center">
                                <div class="row">
                                    ...
                                    <h6 class="col-sm-12">
                                        ...
                                        <span>
                                            <?php
                                            $formattedNumber = number_format($row['GIA']);
...
<section class="shop_section layout_padding">
    <div class="container">
        ...
        <div class="row">
            <?php
            while ($row = mysqli_fetch_array($hot_product)) { ?>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="index.php?act=detail&id=<?php echo $row['MA_XE']; ?>">
                            <div class="img-box">
                        ...
                        <form method="POST" action="" class="d-flex justify-content-center">
                            <input type="hidden" name="ma_xe" value="<?php echo $row['MA_XE']; ?>">
                            <button type="submit" name="add_to_cart_hot" class="btn btn-primary w-100 mt-3">Thêm vào giỏ
                                hàng</button>
                        </form>
                    </div>
                </div>
        ...
        <?php
        if (isset($_POST['add_to_cart_hot'])) {
            $product_id = $_POST['ma_xe'];
            $userId = $_SESSION['user'];
    ...
    <div class="box">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="img-box">
                        <img src="images/about-more.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="detail-box">
                        <div class="heading_container">
                            <h2>
                                Sản phẩm được bán <br> chạy nhất
                            </h2>
                        </div>
                        <p>
                            Yamaha FreeGo bản tiêu chuẩn được đại lý chào bán với mức giá từ 26,5 triệu đồng và bản S là
                            30 triệu đồng (giảm khoảng 4 triệu đồng so với giá niêm yết).
                        </p>
                        <div class="btn-box">
                            <a href="#" class="btn1">
                                Mua ngay
...
<section class="why_section layout_padding">
    <div class="container">
        <div class="heading_container heading_center">
            <h2>
                Lý do nên mua hàng ở chúng tôi
            </h2>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box ">
                 ...
                 c5.888,0,10.667-4.779,10.667-10.667S379.221,234.667,373.333,234.667z" />
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Nhiều voucher giảm giá hấp dẫn.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="box">
                        ...
                        <p>
                            Cửa hàng APT là một địa chỉ uy tín và đáng tin cậy chuyên cung cấp các dòng xe máy chất
                            lượng cao tại Việt Nam. Với nhiều năm kinh nghiệm trong ngành, APT cam kết mang đến cho
                            khách hàng những sản phẩm xe máy đa dạng từ các hãng nổi tiếng như Honda, Yamaha,
                            và Suzuki. Mỗi sản phẩm tại cửa hàng đều được chọn lọc kỹ lưỡng, đảm bảo về chất lượng cũng
                            như giá cả hợp lý, đáp ứng nhu cầu của mọi khách hàng.
                        </p>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="box">
                        ...
                        <p>
                            Bên cạnh việc cung cấp các dòng xe máy mới, APT còn có các chương trình khuyến mãi hấp dẫn
                            và dịch vụ hậu mãi chu đáo. Khách hàng mua xe tại APT sẽ được hưởng chính sách bảo hành dài
                            hạn, cùng với đó là dịch vụ bảo dưỡng và sửa chữa chuyên nghiệp. Đội
                            ngũ nhân viên giàu kinh nghiệm của cửa hàng luôn sẵn sàng hỗ trợ khách hàng trong việc lựa
                            chọn xe và cung cấp thông tin chi tiết về từng sản phẩm. </p>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="box">
                        ...
                        <p>
                            Ngoài ra, APT còn nổi bật với dịch vụ chăm sóc khách hàng tận tâm và tư vấn tài chính linh
                            hoạt. Cửa hàng cung cấp nhiều phương thức thanh toán và hỗ trợ vay trả góp lãi suất thấp,
                            giúp khách hàng dễ dàng sở hữu chiếc xe mơ ước. Với phương châm "Uy tín
                            - Chất lượng - Tận tâm", APT luôn không ngừng nâng cao chất lượng dịch vụ để mang lại sự hài
                            lòng tối đa cho khách hàng. </p>
                    </div>
                </div>
            </div>
            <div class="carousel_btn-box">
